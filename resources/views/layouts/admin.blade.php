    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-mini"><b>SH</b>V</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>Sistema Himnario</b></span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">Serrar Sesión</span>
                </a>
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <!-- <p>
                      johtiben@gmail.com - Desarrollando Software
                      <small>Cel: 73710861</small>
                    </p> -->
                  </li>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu ">
                <li><a href="{{url('almacen/articulo')}}"><i class="fa fa-music"></i> Himnos</a></li>
                <li><a href="{{url('almacen/categoria')}}"><i class="fa fa-book"></i> Himnarios</a></li>
              </ul>
            </li>
            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">Sistema Himnario</h3>
